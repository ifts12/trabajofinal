...
<div class="container">
    <h3>Presentarse en seccional correspondiente</h3>
    <p>Deberá traer:
    <ul> 
    	<li><i class="far fa-id-card"></i> Original y Fotocopias de:
    		<ul>
    			<li>D.N.I. de titular y grupo familiar</li>
    			<li>D.N.I. de los invitados</li>
    		</ul>
    	</li>
    	<li>
