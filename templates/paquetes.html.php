		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="caja-simple border">
						<div class="caja-thumb">
							<img class="img-fluid" src="images/promo01.jpg" alt="">
						</div>
						<div class="p-4">
							<div class="pt-2">
								<span>Mendoza</span>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="caja-simple border">
						<div class="caja-thumb">
							<img class="img-fluid" src="images/promo02.jpg" alt="">
						</div>
						<div class="p-4">
							<div class="pt-2">
								<span>San Luis</span>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="caja-simple border">
						<div class="caja-thumb">
							<img class="img-fluid" src="images/promo03.jpg" alt="">
						</div>
						<div class="p-4">
							<div class="pt-2">
								<span>Córdoba</span>
